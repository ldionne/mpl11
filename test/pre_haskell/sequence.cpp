...
static_assert(length<sequence<0>>::value == 1, "");
static_assert(length<sequence<0, 1>>::value == 2, "");
static_assert(length<sequence<0, 1, 2>>::value == 3, "");
static_assert(length<sequence<0, 1, 2, 3>>::value == 4, "");
static_assert(length<sequence<0, 1, 2, 3, 4>>::value == 5, "");
