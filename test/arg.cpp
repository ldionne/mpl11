...
static_assert(is_same<apply_t<arg<0>, a1>, a1>::value, "");
static_assert(is_same<apply_t<arg<0>, a1, a2>, a1>::value, "");
static_assert(is_same<apply_t<arg<0>, a1, a2, a3>, a1>::value, "");

static_assert(is_same<apply_t<arg<1>, a1, a2>, a2>::value, "");
static_assert(is_same<apply_t<arg<1>, a1, a2, a3>, a2>::value, "");
static_assert(is_same<apply_t<arg<1>, a1, a2, a3, a4>, a2>::value, "");

static_assert(is_same<apply_t<arg<2>, a1, a2, a3>, a3>::value, "");
static_assert(is_same<apply_t<arg<2>, a1, a2, a3, a4>, a3>::value, "");
static_assert(is_same<apply_t<arg<2>, a1, a2, a3, a4, a5>, a3>::value, "");

static_assert(is_same<apply_t<arg<3>, a1, a2, a3, a4>, a4>::value, "");
static_assert(is_same<apply_t<arg<3>, a1, a2, a3, a4, a5>, a4>::value, "");
static_assert(is_same<apply_t<arg<3>, a1, a2, a3, a4, a5, a6>, a4>::value, "");
