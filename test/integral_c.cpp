...
#include <boost/mpl11/detail/test_logical.hpp>
...
/**/
    ...
    static_assert(sizeof(
        detail::test_logical<
            integral_c<T, static_cast<T>(false)>,
            integral_c<T, static_cast<T>(true)>
        >
    ), "");
    ...
    class nested_stuff {
        ...
        static_assert(detail::is_same<ValueType, T>::value, "");
...
struct generate_inputs :
    invert_inputs<F, T, 0, 1>, invert_inputs<F, T, 0, 2>, invert_inputs<F, T, 0, 3>, invert_inputs<F, T, 0, 4>,
    invert_inputs<F, T, 1, 1>, invert_inputs<F, T, 1, 2>, invert_inputs<F, T, 1, 3>, invert_inputs<F, T, 1, 4>,
    invert_inputs<F, T, 2, 1>, invert_inputs<F, T, 2, 2>, invert_inputs<F, T, 2, 3>, invert_inputs<F, T, 2, 4>,
    invert_inputs<F, T, 3, 1>, invert_inputs<F, T, 3, 2>, invert_inputs<F, T, 3, 3>, invert_inputs<F, T, 3, 4>,
    invert_inputs<F, T, 4, 1>, invert_inputs<F, T, 4, 2>, invert_inputs<F, T, 4, 3>, invert_inputs<F, T, 4, 4>,
    invert_inputs<F, T, 5, 1>, invert_inputs<F, T, 5, 2>, invert_inputs<F, T, 5, 3>, invert_inputs<F, T, 5, 4>,
    invert_inputs<F, T, 6, 1>, invert_inputs<F, T, 6, 2>, invert_inputs<F, T, 6, 3>, invert_inputs<F, T, 6, 4>
{ };
