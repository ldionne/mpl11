...
namespace boost { namespace mpl11 {
    ...
    BOOST_MPL11_DOXYGEN_ALIAS(slice_c, slice<S, size_t<Start>, size_t<Stop>>);
    ...
    BOOST_MPL11_DOXYGEN_ALIAS(at_c, at<S, size_t<Index>>);
     ...
     */
    struct random_access_sequence_tag BOOST_MPL11_DOXYGEN_ONLY({ });
