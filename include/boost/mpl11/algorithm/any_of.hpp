...
namespace boost { namespace mpl11 { namespace algorithm {
    ...
    struct any_of BOOST_MPL11_DOXYGEN_ONLY(<Sequence, Predicate>)
        : detail::tag_dispatched<tag::any_of, Sequence, Predicate>::template
          with_default<
            lazy_always<
                intrinsic::not_<none_of<Sequence, Predicate>>
            >
          >
    { };
    ...
    struct any_of<Sequence>
        : detail::tag_dispatched<tag::any_of, Sequence>::template
          with_default<
            lazy_always<
                any_of<Sequence, _1>
            >
