/*!
 * @file
 * Defines the default implementation of `boost::mpl11::algorithm::advance`.
 */

#ifndef BOOST_MPL11_DETAIL_DEFAULT_ADVANCE_HPP
#define BOOST_MPL11_DETAIL_DEFAULT_ADVANCE_HPP
...
#endif // !BOOST_MPL11_DETAIL_DEFAULT_ADVANCE_HPP
