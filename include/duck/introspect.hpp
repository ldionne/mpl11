...
#ifndef DUCK_INTROSPECT_HPP
#define DUCK_INTROSPECT_HPP
...
#define DUCK_I_DECLARE_PRIMITIVE(T) \
    template <> struct introspect<T> : detail::primitive_base<T> { }
DUCK_I_DECLARE_PRIMITIVE(bool);
DUCK_I_DECLARE_PRIMITIVE(char);
DUCK_I_DECLARE_PRIMITIVE(short);
DUCK_I_DECLARE_PRIMITIVE(int);
DUCK_I_DECLARE_PRIMITIVE(long);
DUCK_I_DECLARE_PRIMITIVE(float);
DUCK_I_DECLARE_PRIMITIVE(double);
DUCK_I_DECLARE_PRIMITIVE(void);
#undef DUCK_I_DECLARE_PRIMITIVE
